...
<div class="py-32 flex justify-center items-center">
    <div class="w-full">
        ...
        <?php endif; ?>
        <form action="<?= base_url('home/laporan/saya/create') ?>" method="POST">
            <div class="block">
                <div class="w-1/2 mt-5">
                    <label for="keluhan" class="block font-medium text-white">Keluhan</label>
                    <textarea type="text" id="keluhan" name="keluhan" class="mt-1 p-2 bg-white text-gray-500 rounded-lg w-full" required>Isi keluhan anda disini</textarea>
                </div>        
            </div>
