    ...
    <div class="py-5">
        <div class="flex gap-3">
            <form action="<?= base_url('dashboard/transaksi/export') ?>" method="POST">
                ...
                <button type="submit" class="bg-blue-500 text-white px-3 py-2 rounded-lg">Export</button>
            </form>
        </div>
    </div>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-white flex gap-2">
                        <a href="<?= base_url('dashboard/transaksi/detail/') ?><?= $item['id']?>"
                            class="bg-sky-500 p-2 rounded-lg">
                        ...
                        <a href="javascript:void(0)"
                            onclick="confirmDelete('<?= base_url('dashboard/transaksi/delete/') ?><?= $item['id']?>')"
