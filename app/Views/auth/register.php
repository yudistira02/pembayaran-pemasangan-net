...
<?= $this->section('content') ?>
    ...
    <div class="animate-slide-top-to-bottom text-gray-800 bg-white transition-all duration-300 md:rounded-2xl shadow-2xl w-[500px]">
        <div class="my-10 mx-10">
            ...
            <form action="<?= base_url('register') ?>" method="POST" class="py-5">
                ...
                <div class="block mt-10">
                    <button class="bg-sky-500 hover:bg-sky-600 transition-colors duration-300 text-white text-1xl font-bold rounded-2xl py-4 px-5 w-full focus:outline-none">REGISTER</button>
                </div>
            </form>
